...
void HAL_ETH_MspDeInit(ETH_HandleTypeDef* ethHandle)
{
  ...
  /* USER CODE END ETH_MspDeInit 0 */
    ...
    PB11     ------> ETH_TX_EN
    */
    HAL_GPIO_DeInit(MII_TXD1_GPIO_Port, MII_TXD1_Pin);

    HAL_GPIO_DeInit(GPIOC, MII_MDC_Pin|MII_RXD0_Pin|MII_RXD1_Pin);

    HAL_GPIO_DeInit(GPIOA, MII_REF_CLK_Pin|MII_MDIO_Pin|MII_CSR_DV_Pin);

    HAL_GPIO_DeInit(GPIOB, MII_TXD0_Pin|MII_TX_EN_Pin);
